 ...
 * 			naming, status LED control, and error level reporting with visual
 * 			feedback.
...
/**
 * @brief	Start the system service (starts the RTOS scheduler — does not return)
 * @retval	::system_status_t
 */
 ...
 * @param	deviceNameSize: Pointer to variable containing buffer size,
 *                          updated with actual name length
 * @retval	::system_status_t
 */
