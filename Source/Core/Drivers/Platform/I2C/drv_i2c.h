 ...
 * @{
 */
#define DRV_I2C_INSTANCES_MAX_NUMBER		CONF_I2C_INSTANCES_MAX_NUMBER

#define DRV_I2C_TIMING_100KHZ				0x10903333

#define DRV_I2C_TIMING_400KHZ				0x00702991U
...
typedef enum
{
	DRV_I2C_INSTANCE_1 = 0,			/*!< I2C peripheral instance 1 (PB6/7)*/
	DRV_I2C_INSTANCE_2 = 1,			/*!< I2C peripheral instance 2 (PB10/11)*/
	DRV_I2C_INSTANCE_3 = 2			/*!< I2C peripheral instance 3 (PC0/1)*/
}drv_i2c_instance_t;
