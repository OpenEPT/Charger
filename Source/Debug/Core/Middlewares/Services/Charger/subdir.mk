...
C_SRCS += \
../Core/Middlewares/Services/Charger/charger.c 

OBJS += \
./Core/Middlewares/Services/Charger/charger.o 

C_DEPS += \
./Core/Middlewares/Services/Charger/charger.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Middlewares/Services/Charger/%.o Core/Middlewares/Services/Charger/%.su Core/Middlewares/Services/Charger/%.cyclo: ../Core/Middlewares/Services/Charger/%.c Core/Middlewares/Services/Charger/subdir.mk
...
clean: clean-Core-2f-Middlewares-2f-Services-2f-Charger

clean-Core-2f-Middlewares-2f-Services-2f-Charger:
	-$(RM) ./Core/Middlewares/Services/Charger/charger.cyclo ./Core/Middlewares/Services/Charger/charger.d ./Core/Middlewares/Services/Charger/charger.o ./Core/Middlewares/Services/Charger/charger.su

.PHONY: clean-Core-2f-Middlewares-2f-Services-2f-Charger
