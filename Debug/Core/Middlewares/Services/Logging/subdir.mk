...
C_SRCS += \
../Core/Middlewares/Services/Logging/logging.c 

OBJS += \
./Core/Middlewares/Services/Logging/logging.o 

C_DEPS += \
./Core/Middlewares/Services/Logging/logging.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Middlewares/Services/Logging/%.o Core/Middlewares/Services/Logging/%.su Core/Middlewares/Services/Logging/%.cyclo: ../Core/Middlewares/Services/Logging/%.c Core/Middlewares/Services/Logging/subdir.mk
...
clean: clean-Core-2f-Middlewares-2f-Services-2f-Logging

clean-Core-2f-Middlewares-2f-Services-2f-Logging:
	-$(RM) ./Core/Middlewares/Services/Logging/logging.cyclo ./Core/Middlewares/Services/Logging/logging.d ./Core/Middlewares/Services/Logging/logging.o ./Core/Middlewares/Services/Logging/logging.su

.PHONY: clean-Core-2f-Middlewares-2f-Services-2f-Logging
