...
C_SRCS += \
../Core/Drivers/Platform/GPIO/drv_gpio.c 

OBJS += \
./Core/Drivers/Platform/GPIO/drv_gpio.o 

C_DEPS += \
./Core/Drivers/Platform/GPIO/drv_gpio.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Drivers/Platform/GPIO/%.o Core/Drivers/Platform/GPIO/%.su Core/Drivers/Platform/GPIO/%.cyclo: ../Core/Drivers/Platform/GPIO/%.c Core/Drivers/Platform/GPIO/subdir.mk
...
clean: clean-Core-2f-Drivers-2f-Platform-2f-GPIO

clean-Core-2f-Drivers-2f-Platform-2f-GPIO:
	-$(RM) ./Core/Drivers/Platform/GPIO/drv_gpio.cyclo ./Core/Drivers/Platform/GPIO/drv_gpio.d ./Core/Drivers/Platform/GPIO/drv_gpio.o ./Core/Drivers/Platform/GPIO/drv_gpio.su

.PHONY: clean-Core-2f-Drivers-2f-Platform-2f-GPIO
