...
typedef enum
{
	...
	DRV_AIN_ADC_RESOLUTION_6BIT 	= 6,		/*!< 8-bit resolution */
...
typedef enum
{
	...
	DRV_AIN_ADC_SAMPLE_TIME_6C5 	= 6,		/*!< 6.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_12C5 	= 12,		/*!< 12.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_24C5 	= 24,		/*!< 24.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_47C5 	= 47,		/*!< 47.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_92C5 	= 92,		/*!< 92.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_247C5 	= 247,		/*!< 247.5 clock cycles */
	DRV_AIN_ADC_SAMPLE_TIME_640C5 	= 640		/*!< 640.5 clock cycles */
